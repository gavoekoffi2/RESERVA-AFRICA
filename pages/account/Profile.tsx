        ...
        <div className="lg:col-span-9 flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-[#1a202c] rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-800">
            <div className="flex gap-5 items-center mb-6">
              <div className="size-24 rounded-full bg-cover bg-center" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=200&h=200")'}}></div>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-1">
                ...
                <input className="rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 bg-transparent dark:text-white" type="text" defaultValue="Jean" />
              </div>
              <div className="flex flex-col gap-1">
                <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Nom</label>
                <input className="rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 bg-transparent dark:text-white" type="text" defaultValue="Dupont" />
              </div>
              <div className="flex flex-col gap-1 md:col-span-2">
                <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Email</label>
                <input className="rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 bg-transparent dark:text-white" type="email" defaultValue="jean.dupont@email.com" />
              </div>
              <div className="flex flex-col gap-1 md:col-span-2">
                <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Bio</label>
                <textarea className="rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 bg-transparent dark:text-white" rows={3} defaultValue="Passionné de voyage et de photographie. J'aime découvrir de nouvelles cultures."></textarea>
              </div>
            </form>

            <div className="flex justify-end gap-4 mt-8">
              <button className="px-6 py-2 border border-gray-300 rounded-lg font-bold hover:bg-gray-50 transition-colors">Annuler</button>
              <button className="px-6 py-2 bg-black text-white rounded-lg font-bold hover:bg-gray-800 transition-colors">Enregistrer</button>
            </div>
          </div>
        </div>
      </div>
